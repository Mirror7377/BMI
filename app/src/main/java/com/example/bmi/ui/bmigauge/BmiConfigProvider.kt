...
object BmiConfigProvider {
    ...
    private val childRangeMap = mapOf(
        ...
        Pair(17, Gender.MALE) to 16.0f..29.0f,
    ...
    // -------- 完整的儿童分界值 (使用 Pair<年龄, 性别> 作为键) --------
    private val childSplitMap = mapOf(
        // ========== 女童 (FEMALE) ==========
        Pair(2, Gender.FEMALE) to Triple(14.4f, 18.0f, 19.1f),
        Pair(3, Gender.FEMALE) to Triple(14.0f, 17.3f, 18.3f),
        Pair(4, Gender.FEMALE) to Triple(13.7f, 16.8f, 18.0f),
        Pair(5, Gender.FEMALE) to Triple(13.5f, 16.8f, 18.3f),
        Pair(6, Gender.FEMALE) to Triple(13.4f, 17.2f, 18.8f),
        Pair(7, Gender.FEMALE) to Triple(13.5f, 17.6f, 19.6f),
        Pair(8, Gender.FEMALE) to Triple(13.6f, 18.4f, 20.6f),
        Pair(9, Gender.FEMALE) to Triple(13.8f, 19.2f, 21.8f),
        Pair(10, Gender.FEMALE) to Triple(14.0f, 20.0f, 23.0f),
        Pair(11, Gender.FEMALE) to Triple(14.8f, 21.7f, 25.2f),
        Pair(12, Gender.FEMALE) to Triple(14.8f, 21.7f, 25.2f),
        Pair(13, Gender.FEMALE) to Triple(15.4f, 22.6f, 26.4f),
        Pair(14, Gender.FEMALE) to Triple(15.8f, 23.4f, 27.2f),
        Pair(15, Gender.FEMALE) to Triple(16.4f, 24.1f, 28.1f),
        Pair(16, Gender.FEMALE) to Triple(16.8f, 24.6f, 28.9f),
        Pair(17, Gender.FEMALE) to Triple(17.2f, 25.2f, 29.6f),
        Pair(18, Gender.FEMALE) to Triple(17.6f, 25.6f, 30.4f),
        Pair(19, Gender.FEMALE) to Triple(17.8f, 26.2f, 31.0f),
        Pair(20, Gender.FEMALE) to Triple(17.9f, 26.5f, 31.7f),

        // ========== 男童 (MALE) ==========
        Pair(2, Gender.MALE) to Triple(14.8f, 18.2f, 19.3f),
        Pair(3, Gender.MALE) to Triple(14.4f, 17.4f, 18.3f),
        Pair(4, Gender.MALE) to Triple(14.0f, 16.9f, 18.0f),
        Pair(5, Gender.MALE) to Triple(13.8f, 16.8f, 18.1f),
        Pair(6, Gender.MALE) to Triple(13.7f, 17.0f, 18.6f),
        Pair(7, Gender.MALE) to Triple(13.6f, 17.4f, 19.2f),
        Pair(8, Gender.MALE) to Triple(13.7f, 17.8f, 20.0f),
        Pair(9, Gender.MALE) to Triple(14.0f, 18.6f, 21.1f),
        Pair(10, Gender.MALE) to Triple(14.2f, 19.4f, 22.2f),
        Pair(11, Gender.MALE) to Triple(14.5f, 20.0f, 23.2f),
        Pair(12, Gender.MALE) to Triple(15.0f, 21.0f, 24.2f),
        Pair(13, Gender.MALE) to Triple(15.5f, 21.7f, 25.4f),
        Pair(14, Gender.MALE) to Triple(16.0f, 22.6f, 26.0f),
        Pair(15, Gender.MALE) to Triple(16.5f, 23.5f, 26.8f),
        Pair(16, Gender.MALE) to Triple(17.1f, 24.2f, 27.7f),
        Pair(17, Gender.MALE) to Triple(17.6f, 24.8f, 28.3f),
        Pair(18, Gender.MALE) to Triple(18.3f, 25.6f, 29.0f),
        Pair(19, Gender.MALE) to Triple(18.5f, 26.4f, 29.8f),
        Pair(20, Gender.MALE) to Triple(18.5f, 27.2f, 30.7f)
    )
    ...
    fun getConfig(age: Int, gender: String): BmiGaugeConfig {
        ...
        return if (age > 20) {
            ...
            val splits = listOf(triple.first, triple.second, triple.third)
            val colors = listOf(
                0xFF5BB1F5.toInt(), // Underweight
                0xFFA8C526.toInt(), // Normal
                0xFFFECD2E.toInt(), // Overweight
    ...
    fun classifyChild(age: Int, gender: String, bmi: Double): BmiLevel {
        val genderEnum = if (gender == Gender.MALE.name) Gender.MALE else Gender.FEMALE
        val splits = childSplitMap[Pair(age, genderEnum)] ?: return BmiLevel.UNDERWEIGHT
